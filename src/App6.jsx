...
const STORAGE_KEY = "usthb_teachers_overrides";

function loadOverrides() {
  try {
    const raw = localStorage.getItem(STORAGE_KEY);
    return raw ? JSON.parse(raw) : { added: [], updated: {} };
...
function mergeTeachers(base, overrides) {
  // Apply updates to base teachers
  const merged = base.map(t =>
    overrides.updated[t.id] ? { ...t, ...overrides.updated[t.id] } : t
  );
  // Append added teachers (avoid duplicates by id)
  const baseIds = new Set(merged.map(t => t.id));
  for (const t of overrides.added) {
    if (!baseIds.has(t.id)) merged.push(t);
  }
  return merged;
}
...
const mathTeachers = [
  {
    "id": 724,
    "nom": "ABBACI Brahim",
    "departement": "Algèbre et Théorie des Nombres",
    ...
    "bio": "Maître de Conférences A au département de Algèbre et Théorie des Nombres de la Faculté de Mathématiques de l'USTHB.",
    "projets": 0
  },
  {
    "id": 725,
    ...
    "bio": "Maître de Conférences B au département de Algèbre et Théorie des Nombres de la Faculté de Mathématiques de l'USTHB.",
    "projets": 0
  },
  {
    "id": 726,
  ...
  },
  {
    ...
    "bio": "Maître Assistant A au département de Algèbre et Théorie des Nombres de la Faculté de Mathématiques de l'USTHB.",
    "projets": 0
  },
  {
    "id": 728,
    "nom": "AIT AMRANE Yacine",
    "departement": "Algèbre et Théorie des Nombres",
    "faculte": "Mathématiques",
    "grade": "Professeur",
    "email": "yacinait@gmail.com",
    ...
    "bio": "Professeur au département de Algèbre et Théorie des Nombres de la Faculté de Mathématiques de l'USTHB.",
    "projets": 0
  },
  {
    "id": 729,
    "nom": "ATMANI Sofiane Abdelhamid",
    "departement": "Algèbre et Théorie des Nombres",
    "faculte": "Mathématiques",
    "grade": "Maître de Conférences B",
    "email": "atmani.sofiane@hotmail.com",
  ...
  },
  {
    ...
    "bio": "Maître Assistant B au département de Algèbre et Théorie des Nombres de la Faculté de Mathématiques de l'USTHB.",
    "projets": 0
  },
  {
    "id": 757,
    "nom": "ZERROUKHAT Leila Schehrazade",
    "departement": "Algèbre et Théorie des Nombres",
    "faculte": "Mathématiques",
    "grade": "Maître de Conférences B",
    "email": "szerroukhat@yahoo.fr",
  ...
  {
    "id": 759,
    "nom": "BENOUMHANI Safia Manar Elislam",
    "departement": "Algèbre et Théorie des Nombres",
    "faculte": "Mathématiques",
    "grade": "Maître Assistant B",
    "email": "benoumhani.s@gmail.com",
    "competences": [
      "Algèbre",
      "Théorie des Groupes",
      "Théorie des Nombres",
  ...
  },
  {
    ...
    "faculte": "Mathématiques",
    "grade": "Maître Assistant B",
    "email": "bensella.hayet@gmail.com",
    "competences": [
      "Algèbre",
      "Théorie des Groupes",
      "Théorie des Nombres",
  ...
  },
  {
    ...
    "faculte": "Mathématiques",
    "grade": "Maître Assistant B",
    "email": "benatmanesara34@gmail.com",
    "competences": [
      "Algèbre",
      "Théorie des Groupes",
      "Théorie des Nombres",
  ...
  },
  {
    ...
    "faculte": "Mathématiques",
    "grade": "Maître Assistant B",
    "email": "rchergui.usthb@gmail.com",
    "competences": [
      "Algèbre",
      "Théorie des Groupes",
      "Théorie des Nombres",
  ...
  {
    "id": 765,
    "nom": "OULD MOHAMED Rezki",
    "departement": "Algèbre et Théorie des Nombres",
    "faculte": "Mathématiques",
    "grade": "Maître Assistant B",
    "email": "ouldmohamed15@gmail.com",
    "competences": [
      "Algèbre",
      "Théorie des Groupes",
      "Théorie des Nombres",
  ...
  },
  {
    ...
    "faculte": "Mathématiques",
    "grade": "Maître Assistant B",
    "email": "oulebsir.assia@hotmail.com",
    "competences": [
      "Algèbre",
      "Théorie des Groupes",
      "Théorie des Nombres",
  ...
  },
  {
    ...
    "bio": "Maître de Conférences B au département de Analyse de la Faculté de Mathématiques de l'USTHB.",
    "projets": 0
  },
  {
    "id": 770,
    ...
    "bio": "Maître de Conférences A au département de Analyse de la Faculté de Mathématiques de l'USTHB.",
    "projets": 0
  },
  {
    "id": 771,
  ...
  },
  {
    ...
    "bio": "Professeur au département de Analyse de la Faculté de Mathématiques de l'USTHB.",
    "projets": 0
  },
  {
    "id": 776,
    "nom": "AIT YAHIA Mohamed mourad lhannafi",
    "departement": "Analyse",
    "faculte": "Mathématiques",
    "grade": "Maître de Conférences B",
    "email": "aityahiamourad@gmail.com",
    "competences": [
      "Analyse Mathématique",
      "Equations Différentielles",
      "Analyse Fonctionnelle",
  ...
  },
  {
    ...
    "bio": "Maître Assistant A au département de Analyse de la Faculté de Mathématiques de l'USTHB.",
    "projets": 0
  },
  {
    "id": 779,
  ...
  },
  {
    ...
    "faculte": "Mathématiques",
    "grade": "Maître Assistant B",
    "email": "louiza.baymout@gmail.com",
    "competences": [
      "Analyse Mathématique",
      "Equations Différentielles",
      "Analyse Fonctionnelle",
    ...
    "bio": "Maître Assistant B au département de Analyse de la Faculté de Mathématiques de l'USTHB.",
    "projets": 0
  },
  {
    "id": 783,
  ...
  {
    "id": 798,
    "nom": "BOUTARENE Khaled el ghaouti",
    "departement": "Analyse",
    "faculte": "Mathématiques",
    "grade": "Maître de Conférences A",
    "email": "boutarenekhaled@yahoo.fr",
  ...
  },
  {
    ...
    "faculte": "Mathématiques",
    "grade": "Assistant",
    "email": "abdellah_eta@hotmail.com",
    "competences": [
      "Analyse Mathématique",
      "Equations Différentielles",
      "Analyse Fonctionnelle",
    ...
    "bio": "Assistant au département de Analyse de la Faculté de Mathématiques de l'USTHB.",
    "projets": 0
  },
  {
    "id": 839,
  ...
  {
    "id": 843,
    "nom": "ALLAOUI Nour elhouda",
    "departement": "Analyse",
    "faculte": "Mathématiques",
    "grade": "Maître Assistant B",
    "email": "nourallaoui95@gmail.com",
    "competences": [
      "Analyse Mathématique",
      "Equations Différentielles",
      "Analyse Fonctionnelle",
  ...
  },
  {
    ...
    "faculte": "Mathématiques",
    "grade": "Maître Assistant B",
    "email": "a.allam@centre-univ-mila.dz",
    "competences": [
      "Analyse Mathématique",
      "Equations Différentielles",
      "Analyse Fonctionnelle",
  ...
  {
    "id": 848,
    "nom": "HASSAINE Slimane",
    "departement": "Analyse",
    "faculte": "Mathématiques",
    "grade": "Maître Assistant B",
    "email": "hassaineslimane63@gmail.com",
    "competences": [
      "Analyse Mathématique",
      "Equations Différentielles",
      "Analyse Fonctionnelle",
  ...
  },
  {
    ...
    "faculte": "Mathématiques",
    "grade": "Maître Assistant B",
    "email": "kechichdounia19@gmail.com",
    "competences": [
      "Analyse Mathématique",
      "Equations Différentielles",
      "Analyse Fonctionnelle",
  ...
  },
  {
    "id": 851,
    "nom": "ADJOUDJ Latifa",
    "departement": "Probabilités et Statistiques",
    "faculte": "Mathématiques",
    "grade": "Maître de Conférences B",
    "email": "latifa.adjoudj@yahoo.fr",
    "competences": [
      "Probabilités",
      "Statistiques",
    ...
    "bio": "Maître de Conférences B au département de Probabilités et Statistiques de la Faculté de Mathématiques de l'USTHB.",
    "projets": 0
  },
  {
    "id": 852,
    ...
    "bio": "Maître Assistant A au département de Probabilités et Statistiques de la Faculté de Mathématiques de l'USTHB.",
    "projets": 0
  },
  {
    "id": 853,
    ...
    "faculte": "Mathématiques",
    "grade": "Maître de Conférences B",
    "email": "bentarziouissam@gmail.com",
    "competences": [
      "Probabilités",
      "Statistiques",
      "Modélisation Stochastique",
  ...
  },
  {
    ...
    "bio": "Maître Assistant B au département de Probabilités et Statistiques de la Faculté de Mathématiques de l'USTHB.",
    "projets": 0
  },
  {
    "id": 857,
    "nom": "BOUKERTOUTA Hanane",
    "departement": "Probabilités et Statistiques",
    "faculte": "Mathématiques",
    "grade": "Maître Assistant A",
    "email": "boukertouta_hanane@yahoo.fr",
    "competences": [
      "Probabilités",
      "Statistiques",
      "Modélisation Stochastique",
  ...
  },
  {
    ...
    "faculte": "Mathématiques",
    "grade": "Maître Assistant A",
    "email": "asma.boussalem01@gmail.com",
    "competences": [
      "Probabilités",
      "Statistiques",
      "Modélisation Stochastique",
  ...
  {
    "id": 861,
    "nom": "EL MAHDAOUI Assia",
    "departement": "Probabilités et Statistiques",
    "faculte": "Mathématiques",
    "grade": "Maître de Conférences B",
    "email": "assia.elmahdaoui@usthb.edu.dz",
    "competences": [
      "Probabilités",
      "Statistiques",
      "Modélisation Stochastique",
  ...
  },
  {
    ...
    "faculte": "Mathématiques",
    "grade": "Professeur",
    "email": "zohra.guessoum@usthb.edu.dz",
    "competences": [
      "Probabilités",
      "Statistiques",
      "Modélisation Stochastique",
    ...
    "bio": "Professeur au département de Probabilités et Statistiques de la Faculté de Mathématiques de l'USTHB.",
    "projets": 0
  },
  {
    "id": 864,
    "nom": "IMEÇAOUDENE Kahina",
    "departement": "Probabilités et Statistiques",
    "faculte": "Mathématiques",
    "grade": "Maître de Conférences B",
    "email": "kahina.imessaoudene@yahoo.fr",
    "competences": [
      "Probabilités",
      "Statistiques",
      "Modélisation Stochastique",
  ...
  {
    "id": 868,
    "nom": "KHEFFACHE Djedjiga",
    "departement": "Probabilités et Statistiques",
    "faculte": "Mathématiques",
    "grade": "Maître de Conférences B",
    "email": "dj_kheffache11@yahoo.fr",
    "competences": [
      "Probabilités",
      "Statistiques",
      "Modélisation Stochastique",
  ...
  },
  {
    ...
    "faculte": "Mathématiques",
    "grade": "Maître Assistant A",
    "email": "souhila_merabet@yahoo.fr",
    "competences": [
      "Probabilités",
      "Statistiques",
      "Modélisation Stochastique",
  ...
  {
    "id": 873,
    "nom": "MEZIANI Mohamed Aymen",
    "departement": "Probabilités et Statistiques",
    "faculte": "Mathématiques",
    "grade": "Maître de Conférences B",
    "email": "aymenmeziani@gmail.com",
    "competences": [
      "Probabilités",
      "Statistiques",
      "Modélisation Stochastique",
  ...
  },
  {
    ...
    "faculte": "Mathématiques",
    "grade": "Maître de Conférences B",
    "email": "wassila.nissas@gmail.com",
    "competences": [
      "Probabilités",
      "Statistiques",
      "Modélisation Stochastique",
  ...
  },
  {
    ...
    "bio": "Maître de Conférences A au département de Probabilités et Statistiques de la Faculté de Mathématiques de l'USTHB.",
    "projets": 0
  },
  {
    "id": 880,
    "nom": "TATACHAK Abdelkader",
    "departement": "Probabilités et Statistiques",
    "faculte": "Mathématiques",
    "grade": "Professeur",
    "email": "atatachak@usthb.dz",
    "competences": [
      "Probabilités",
      "Statistiques",
      "Modélisation Stochastique",
  ...
  {
    "id": 882,
    "nom": "YAZI Mohand amokrane",
    "departement": "Probabilités et Statistiques",
    "faculte": "Mathématiques",
    "grade": "Maître de Conférences B",
    "email": "mohyazi@gmail.com",
    "competences": [
      "Probabilités",
      "Statistiques",
      "Modélisation Stochastique",
  ...
  },
  {
    ...
    "faculte": "Mathématiques",
    "grade": "Maître Assistant A",
    "email": "zaboot-nassima@hotmail.com",
    "competences": [
      "Probabilités",
      "Statistiques",
      "Modélisation Stochastique",
  ...
  {
    "id": 884,
    "nom": "ZEGHIDI Leila-Mabrouka",
    "departement": "Probabilités et Statistiques",
    "faculte": "Mathématiques",
    "grade": "Maître Assistant A",
    "email": "zeghidi_leila_mabrouka@yahoo.fr",
    "competences": [
      "Probabilités",
      "Statistiques",
      "Modélisation Stochastique",
  ...
  {
    "id": 886,
    "nom": "BELDJOUDI Chouaib",
    "departement": "Probabilités et Statistiques",
    "faculte": "Mathématiques",
    "grade": "Maître Assistant B",
    "email": "beldjoudichouaib@gmail.com",
    "competences": [
      "Probabilités",
      "Statistiques",
      "Modélisation Stochastique",
  ...
  {
    "id": 887,
    "nom": "BENZAMOUCHE Sabrina",
    "departement": "Probabilités et Statistiques",
    "faculte": "Mathématiques",
    "grade": "Maître Assistant B",
    "email": "sabrina.o.benzamouche@gmail.com",
    "competences": [
      "Probabilités",
      "Statistiques",
      "Modélisation Stochastique",
  ...
  },
  {
    ...
    "faculte": "Mathématiques",
    "grade": "Maître Assistant B",
    "email": "rihsoumiamaths@gmail.com",
    "competences": [
      "Probabilités",
      "Statistiques",
      "Modélisation Stochastique",
  ...
  },
  {
    "id": 895,
    "nom": "ABBAS Moncef",
    "departement": "Recherche Opérationnelle",
    "faculte": "Mathématiques",
    "grade": "Professeur",
    "email": "moncef_abbas@yahoo.com",
    "competences": [
      "Optimisation",
      "Graphes",
    ...
    "bio": "Professeur au département de Recherche Opérationnelle de la Faculté de Mathématiques de l'USTHB.",
    "projets": 0
  },
  {
    "id": 896,
    "nom": "ABDERRAHMANI Amal",
    "departement": "Recherche Opérationnelle",
    "faculte": "Mathématiques",
    "grade": "Maître Assistant A",
    "email": "nadjema2007@yahoo.fr",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
    ...
    "bio": "Maître Assistant A au département de Recherche Opérationnelle de la Faculté de Mathématiques de l'USTHB.",
    "projets": 0
  },
  {
    "id": 897,
    "nom": "AFFIF CHAOUCHE Fatima",
    "departement": "Recherche Opérationnelle",
    "faculte": "Mathématiques",
    "grade": "Maître de Conférences A",
    "email": "f_affif@yahoo.fr",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
    ...
    "bio": "Maître de Conférences A au département de Recherche Opérationnelle de la Faculté de Mathématiques de l'USTHB.",
    "projets": 0
  },
  {
    "id": 898,
    ...
    "bio": "Maître de Conférences B au département de Recherche Opérationnelle de la Faculté de Mathématiques de l'USTHB.",
    "projets": 0
  },
  {
    "id": 899,
    ...
    "faculte": "Mathématiques",
    "grade": "Maître Assistant A",
    "email": "rachid.aiche@usthb.edu.dz",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  },
  {
    ...
    "faculte": "Mathématiques",
    "grade": "Professeur",
    "email": "meziane.aider@usthb.edu.dz",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  },
  {
    ...
    "faculte": "Mathématiques",
    "grade": "Maître de Conférences B",
    "email": "lamia.aoudia@usthb.edu.dz",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  {
    "id": 906,
    "nom": "BELBACHIR Hacene",
    "departement": "Recherche Opérationnelle",
    "faculte": "Mathématiques",
    "grade": "Professeur",
    "email": "hacenebelbachir@gmail.com",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  {
    "id": 910,
    "nom": "BENKELFAT Sidi mohamed karim",
    "departement": "Recherche Opérationnelle",
    "faculte": "Mathématiques",
    "grade": "Maître Assistant A",
    "email": "benkelfatsidimohamedkarim@gmail.com",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  {
    "id": 912,
    "nom": "BENMEZIANE Hamida",
    "departement": "Recherche Opérationnelle",
    "faculte": "Mathématiques",
    "grade": "Maître Assistant A",
    "email": "h.benmeziane@yahoo.fr",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  {
    "id": 913,
    "nom": "BENMEZIANE Zineb",
    "departement": "Recherche Opérationnelle",
    "faculte": "Mathématiques",
    "grade": "Professeur",
    "email": "zbenmeziane@yahoo.fr",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  },
  {
    ...
    "faculte": "Mathématiques",
    "grade": "Maître de Conférences B",
    "email": "boumesbah.asma2020@gmail.com",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  },
  {
    ...
    "faculte": "Mathématiques",
    "grade": "Maître de Conférences B",
    "email": "nadaboussaharo@gmail.com",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  {
    "id": 925,
    "nom": "CHAIBLAINE Yacine",
    "departement": "Recherche Opérationnelle",
    "faculte": "Mathématiques",
    "grade": "Maître Assistant B",
    "email": "yacinechaiblaine@gmail.com",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
    ...
    "bio": "Maître Assistant B au département de Recherche Opérationnelle de la Faculté de Mathématiques de l'USTHB.",
    "projets": 0
  },
  {
    "id": 926,
    "nom": "CHERGUI Mohamed el-amine",
    "departement": "Recherche Opérationnelle",
    "faculte": "Mathématiques",
    "grade": "Professeur",
    "email": "mohamedelaminec@yahoo.com",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  {
    "id": 929,
    "nom": "HADJ BRAHIM Slimane",
    "departement": "Recherche Opérationnelle",
    "faculte": "Mathématiques",
    "grade": "Maître de Conférences B",
    "email": "s_hadjbrahim@outlook.com",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  {
    "id": 930,
    "nom": "HADJBENALI Linda khouloud",
    "departement": "Recherche Opérationnelle",
    "faculte": "Mathématiques",
    "grade": "Maître Assistant A",
    "email": "lhadjbenali@usthb.dz",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  },
  {
    ...
    "faculte": "Mathématiques",
    "grade": "Maître de Conférences B",
    "email": "imane.hamidi.ro@gmail.com",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  {
    "id": 936,
    "nom": "KANTOUR Nedjmeddine",
    "departement": "Recherche Opérationnelle",
    "faculte": "Mathématiques",
    "grade": "Maître de Conférences B",
    "email": "nadjmeddine.kantour@usthb.edu.dz",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  {
    "id": 937,
    "nom": "KHALFI Abderaouf",
    "departement": "Recherche Opérationnelle",
    "faculte": "Mathématiques",
    "grade": "Maître de Conférences B",
    "email": "abderaouf.khalfi@usthb.edu.dz",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  {
    "id": 938,
    "nom": "KRIM-DEBIANE Fariza",
    "departement": "Recherche Opérationnelle",
    "faculte": "Mathématiques",
    "grade": "Maître de Conférences B",
    "email": "krimfariza@gmail.com",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  },
  {
    ...
    "faculte": "Mathématiques",
    "grade": "Maître de Conférences B",
    "email": "elsedik.lamini@usthb.edu.dz",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  {
    "id": 942,
    "nom": "MECHEBBEK Meriem",
    "departement": "Recherche Opérationnelle",
    "faculte": "Mathématiques",
    "grade": "Maître de Conférences B",
    "email": "mechebbek_meriem@yahoo.fr",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  {
    "id": 943,
    "nom": "MEDJERREDINE Assia",
    "departement": "Recherche Opérationnelle",
    "faculte": "Mathématiques",
    "grade": "Maître de Conférences B",
    "email": "assiamedjro@gmail.com",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  },
  {
    ...
    "faculte": "Mathématiques",
    "grade": "Professeur",
    "email": "rachid_ouafi@hotmail.com",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  {
    "id": 952,
    "nom": "REZKELLAH Louiza",
    "departement": "Recherche Opérationnelle",
    "faculte": "Mathématiques",
    "grade": "Maître Assistant A",
    "email": "lrezkallah@yahoo.com",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  {
    "id": 953,
    "nom": "SADOUN Mohamed djemaa",
    "departement": "Recherche Opérationnelle",
    "faculte": "Mathématiques",
    "grade": "Maître de Conférences A",
    "email": "mo-hamedsadoun@outlook.fr",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  {
    "id": 958,
    "nom": "SOUKEUR El hussein Iz Elislam",
    "departement": "Recherche Opérationnelle",
    "faculte": "Mathématiques",
    "grade": "Maître de Conférences B",
    "email": "soukeur.islam@gmail.com",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  {
    "id": 959,
    "nom": "TIACHACHAT Meriem",
    "departement": "Recherche Opérationnelle",
    "faculte": "Mathématiques",
    "grade": "Maître de Conférences A",
    "email": "tiachachatmeriem@yahoo.fr",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  {
    "id": 960,
    "nom": "YAGOUNI Mohammed",
    "departement": "Recherche Opérationnelle",
    "faculte": "Mathématiques",
    "grade": "Maître de Conférences B",
    "email": "mohammedyagouni@gmail.com",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  },
  {
    ...
    "faculte": "Mathématiques",
    "grade": "Maître Assistant A",
    "email": "zohra.zitout@usthb.edu.dz",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  {
    "id": 964,
    "nom": "BENAKKOUCHE Lilia",
    "departement": "Recherche Opérationnelle",
    "faculte": "Mathématiques",
    "grade": "Maître Assistant B",
    "email": "manassaslina@gmail.com",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  {
    "id": 965,
    "nom": "BOULEBENE Sabrin",
    "departement": "Recherche Opérationnelle",
    "faculte": "Mathématiques",
    "grade": "Maître Assistant B",
    "email": "sab-rine93@live.fr",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  },
  {
    ...
    "faculte": "Mathématiques",
    "grade": "Maître Assistant B",
    "email": "imene.dey.2018@gmail.com",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  {
    "id": 968,
    "nom": "ELAROUSSI Mohammed",
    "departement": "Recherche Opérationnelle",
    "faculte": "Mathématiques",
    "grade": "Maître Assistant B",
    "email": "elaroussimohammed@yahoo.com",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  },
  {
    ...
    "faculte": "Mathématiques",
    "grade": "Maître Assistant B",
    "email": "mohamed14khemici@gmail.com",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  {
    "id": 973,
    "nom": "NADJI Mohammed Lamine",
    "departement": "Recherche Opérationnelle",
    "faculte": "Mathématiques",
    "grade": "Maître Assistant B",
    "email": "nadjimohammedlamine@gmail.com",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  {
    "id": 975,
    "nom": "OUIDDIR Djedjiga",
    "departement": "Recherche Opérationnelle",
    "faculte": "Mathématiques",
    "grade": "Maître Assistant B",
    "email": "djedjigaou@gmail.com",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
  ...
  {
    "id": 978,
    "nom": "TAMSAOUETE Karima",
    "departement": "Recherche Opérationnelle",
    "faculte": "Mathématiques",
    "grade": "Maître Assistant B",
    "email": "karimamath2013@gmail.com",
    "competences": [
      "Optimisation",
      "Graphes",
      "Programmation Linéaire",
...
const allTeachers = [...initialTeachers, ...newTeachers, ...extraTeachers, ...mathTeachers];
...
export default function App() {
  ...
  const [teachers, setTeachers] = useState(() => mergeTeachers(allTeachers, loadOverrides()));
  ...
  function addTeacher(t) {
    setTeachers(ts => {
      const next = [...ts, t];
      // Persist: load overrides, push new teacher to added list
      const overrides = loadOverrides();
      overrides.added = [...overrides.added.filter(a => a.id !== t.id), t];
  ...
  function updateTeacher(updated) {
    setTeachers(ts => {
      const next = ts.map(t => t.id === updated.id ? updated : t);
      // Persist: store updated fields in overrides.updated
      const overrides = loadOverrides();
      overrides.updated[updated.id] = updated;
      // If it was an added teacher, update in added list too
      overrides.added = overrides.added.map(a => a.id === updated.id ? updated : a);
      saveOverrides(overrides);
      return next;
    });
      ...
      <nav style={{position:"sticky",top:0,zIndex:50,background:"rgba(7,15,29,0.88)",backdropFilter:"blur(16px)",borderBottom:"1px solid rgba(255,255,255,0.07)",padding:"0 20px",display:"flex",alignItems:"center",gap:6,height:56}}>
        ...
        <div style={{marginLeft:"auto",display:"flex",alignItems:"center",gap:12}}>
          {(() => {
            ...
            const modCount = Object.keys(ov.updated).length + ov.added.length;
            return modCount > 0 ? (
              <span title={`${Object.keys(ov.updated).length} modifié(s), ${ov.added.length} ajouté(s)`}
                style={{fontSize:11,color:"#63dcb4",background:"rgba(99,220,180,0.1)",padding:"2px 8px",borderRadius:10,border:"1px solid rgba(99,220,180,0.2)"}}>
                💾 {modCount} modification{modCount>1?"s":""} sauvegardée{modCount>1?"s":""}
              </span>
            ) : null;
          })()}
          <span style={{fontSize:11,color:"#3a4455"}}>USTHB — Sciences de la Terre</span>
        </div>
      </nav>
